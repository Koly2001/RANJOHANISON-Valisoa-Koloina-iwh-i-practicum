...
app.get('/', async (req, res) => {
  try {
    ...
    const response = await axios.get('https://api.hubapi.com/crm/v3/objects/contacts/Pet', {
      headers: {
...
app.get('/update-cobj/:name?', async (req, res) => {
    ...
    if (objName) {
      try {
        const response = await axios.get(`https://api.hubapi.com/crm/v3/objects/contacts/Pet?hapikey=${'pat-eu1-f73f79ce-5d7d-4517-94cd-23d5b9222ed4'}&property=Name&value=${encodeURIComponent(objName)}`);
...
app.post('/update-cobj', async (req, res) => {
    ...
    try {
      if (formData.id) {
        await axios.patch(`https://api.hubapi.com/crm/v3/objects/contacts/Pet${formData.id}`, formData, {
          headers: {
            Authorization: `Bearer ${'pat-eu1-f73f79ce-5d7d-4517-94cd-23d5b9222ed4'}`,
        ...
        await axios.post('https://api.hubapi.com/crm/v3/objects/contacts/Pet', formData, {
          headers: {
            Authorization: `Bearer ${'pat-eu1-f73f79ce-5d7d-4517-94cd-23d5b9222ed4'}`,
            'Content-Type': 'application/json'
          }
